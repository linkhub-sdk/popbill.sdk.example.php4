...
<?php 
	...
	$invoicerMgtKey = '20150209-01';		# 문서관리번호
	...
	$Taxinvoice->writeDate = '20150201';		# [필수] 작성일자, 형식(yyyyMMdd) 예)20150101
...
#	$Taxinvoice->modifyCode = '';					# 수정 사유코드 1 : 기재사항 착오정정, 2 : 공급가액 변동 3 : 환입, 4 : 계약의 해지
	...
	#Update(사업자번호, 발행유형, 원본세금계산서 문서관리번호, 세금계산서객체, 회원아이디, 거래명세서 동시작성여부)
	$Presponse = $TaxinvoiceService->Update($testCorpNum, $mgtKeyType, $invoicerMgtKey, $Taxinvoice, $testUserID, $writeSpecification);
	$code = $Presponse->code;
